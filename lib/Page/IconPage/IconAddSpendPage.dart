...
class _IconAddSpendState extends State<IconAddSpend> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('新增消費'), // 顯示在 AppBar 上的標題
      ),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  labelText: '消費描述', border: OutlineInputBorder()), // 設置輸入框樣式
            ),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  labelText: '消費金額', border: OutlineInputBorder()), // 設置輸入框樣式
            ),
            ...
            ElevatedButton(
              onPressed: () async {
                double spendAmount =
                    double.tryParse(_AmountController.text) ?? 0.0; // 獲取用戶輸入的金額，默認值為 0.0
