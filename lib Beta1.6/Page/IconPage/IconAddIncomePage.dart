...
class IconStorage {
  ...
  Future<List<Map<String, dynamic>>> loadIcon() async {
    ...
    return decodedList.map((Icon) => Map<String, dynamic>.from(Icon)).toList();
  }
}
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: isDarkMode // 設置 AppBar 的背景顏色
            ? const Color.fromARGB(255, 39, 39, 39)
            : const Color.fromARGB(255, 255, 255, 255), // 顯示在 AppBar 上的標題
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                double IconAmount = double.tryParse(_AmountController.text) ??
                    0.0; // 獲取使用者輸入的金額，預設值為 0.0
