          ...
          content: eventsForDay.isEmpty
              ...
              : Column(
                  ...
                  children: eventsForDay.map((event) {
                    bool isCompleted = event['completed'] ?? false; // 檢查事件是否已完成
                    return Padding(
          ...
          Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  DateFormat.yMMM()
                      .format(_currentMonth), // 顯示當前月份和年份，格式為 "yyyy MMM"
            ...
            child: FutureBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return Center(child: CircularProgressIndicator()); // 顯示加載動畫
                }
                  ...
                  slivers: [
                    ...
                    SliverGrid(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        childAspectRatio: 0.62, // 設置每個格子的寬高比，0.62 讓格子更為接近正方形
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                color: isToday
                                    ? Colors.blue // 今天的格子背景色
                                    : Colors.transparent, // 其他日期的背景色
                                borderRadius: BorderRadius.circular(8.0), // 圓角邊框
                              ),
                              child: Column(
                                children: [
                                  // 顯示日期
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: isToday
                                            ? Colors.white // 如果是今天，白色字體顯示
                                            : Colors.black, // 其他日期用黑色字體
                                      ),
                                    ),
                                  ),
